...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({
      all:JSON.parse(options.aid),
    })
    this.setData({
      is_default:this.data.all.is_default
    })
    ...
    // console.log(this.data.all.is_default)
  ...
  mr:function(){
    var that = this
    var mr = this.data.all.is_default
    if(mr == 0){
      that.setData({
        is_default:1,
        mr:'../../icons/xz.png'
